...
import dev.oxydien.mbtym.item.client.CoffeeMachineItemRenderer;
...
public class CoffeeMachineItem extends BlockItem implements GeoItem {
	private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
	private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

	public CoffeeMachineItem(Block block, Settings settings) {
	...
	public void createRenderer(Consumer<Object> consumer) {
		consumer.accept(new RenderProvider() {
			private final CoffeeMachineItemRenderer renderer = new CoffeeMachineItemRenderer();
			@Override
